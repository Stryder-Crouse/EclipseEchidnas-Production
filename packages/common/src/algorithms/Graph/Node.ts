...
export function floorToNumber(floor: string) {
    ...
    switch (floor) {
        case "3":
            return FloorToIndex.Level3;
        case "2":
            return FloorToIndex.Level2;
        case "1":
            return FloorToIndex.Level1;
        case "G":
            return FloorToIndex.Ground; //no nodes with G floor exist right now (i have asked wong about it)
        case "L1":
            return FloorToIndex.LowerLevel1;
        case "L2":
            return FloorToIndex.LowerLevel2;

        default:
            return FloorToIndex.UNDEFINED;
    }
